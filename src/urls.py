...
urlpatterns = [
    ...
    path('courses_list/<int:course_id>/course_parts/<int:part_id>', views.part_details, name='part_details'),    path('document_list/', views.document_list, name='document_list'),
